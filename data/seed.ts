...
import { ETATS_LECTURE } from "../utils/constantesLecture";
  ...
  const livres: Livre[] = [
    {
      ...
      couverture: null,
      type: "broché",
      etat_lecture: ETATS_LECTURE.A_LIRE,
      note: 0,
      avis: null,
      date_debut_lecture: null,
      date_fin_lecture: null,
      statut_possession: STATUT_POSSESSION.EMPRUNTE,
      prix: null,
    ...
    },
    {
      ...
      type: "broché",
      etat_lecture: ETATS_LECTURE.EN_COURS,
      note: 0,
      avis: null,
      date_debut_lecture: "2026-02-14",
      date_fin_lecture: null,
      statut_possession: STATUT_POSSESSION.ACHETE,
      prix: 16.95,
      date_pret: null,
      preteur: null,
      date_ajout: null,
    ...
    },
    {
      ...
      type: "broché",
      etat_lecture: ETATS_LECTURE.ABANDONNE,
      note: 2,
